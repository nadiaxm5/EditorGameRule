  ...
  ""Script"": [
    ...
    private void SyncFromEditorProject()
    {
        ...
        catch (Exception ex)
        {
            ...
            _gameData.CustomVariable   = project.sceneData.CustomVariable != null
                ? new List<CustomVariable>(project.sceneData.CustomVariable)
    ...
    private void SyncToEditorProject()
    {
        ...
        try
        {
            ...
            project.sceneData.CustomVariable = _gameData.CustomVariable;
    ...
    */
    ...
    private string BuildGlobalVariablesContext()
    {
        ...
        if (_gameData?.CustomVariable != null && _gameData.CustomVariable.Count > 0)
        {
            sb.Append(". Custom: ");
            var cvParts = new List<string>();
            foreach (var cv in _gameData.CustomVariable)
            {
