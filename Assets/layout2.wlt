...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 1
      ...
      index: 2
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-151.333251953125,"y":-36.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -151.33325, y: -36}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
...
MonoBehaviour:
  ...
  m_Position:
    m_Target: {x: 0.3562652, y: 0.7435243, z: -0.096204504}
    speed: 2
    m_Value: {x: 0.3562652, y: 0.7435243, z: -0.096204504}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
  ...
  m_Grid:
    ...
    m_gridOpacity: 0.5
  m_Rotation:
    m_Target: {x: -0.33778232, y: -0.22091676, z: 0.08179247, w: -0.9116774}
    speed: 2
    m_Value: {x: -0.33765626, y: -0.22083431, z: 0.08176194, w: -0.91133714}
  m_Size:
    m_Target: 5.164512
    speed: 2
    m_Value: 5.164512
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_HBaseRangeMin: -269.6667
    m_HBaseRangeMax: 269.6667
    m_VBaseRangeMin: -291
    m_VBaseRangeMax: 291
    ...
    m_DrawArea:
      ...
      height: 873
    m_Scale: {x: 1.5, y: 1.5}
    m_Translation: {x: 404.50003, y: 436.5}
    m_MarginLeft: 0
    m_MarginRight: 0
    m_MarginTop: 0
    m_MarginBottom: 0
    ...
    m_MinimalGUI: 1
  m_defaultScale: 1
  m_LastWindowPixelSize: {x: 1213.5, y: 1341}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
