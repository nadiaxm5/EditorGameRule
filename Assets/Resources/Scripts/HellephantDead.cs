...
public class HellephantDead : MonoBehaviour {
    ...
    void Start() {
        scopeList = Utils.CreateScope(gameObject.GetInstanceID(),"Animate(Death);Edit(this.counter,this.counter-1);PlaySound(HellephantDeath);PlayParticles(DeathParticles);Compare(this.counter<0);Delete(this)");
