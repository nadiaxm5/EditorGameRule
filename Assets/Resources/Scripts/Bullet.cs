...
public class Bullet : MonoBehaviour {
    ...
    void Start() {
        scopeList = Utils.CreateScope(gameObject.GetInstanceID(),"Move(this.speed,0,this.ry,0);Collision(Hellephant);Delete(this);Collision(ZomBear);Collision(ZomBunny);Collision(Obstacle)");
