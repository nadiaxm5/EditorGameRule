...
public class ZomBearSpawner : MonoBehaviour {
    ...
    void Start() {
        scopeList = Utils.CreateScope(gameObject.GetInstanceID(),"Edit(this.currentTime,this.currentTime+1);Compare(this.currentTime==this.spawnTime);Edit(this.currentTime,0);Spawn(ZomBear,this)");
