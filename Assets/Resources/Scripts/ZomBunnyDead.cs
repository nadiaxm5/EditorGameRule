...
public class ZomBunnyDead : MonoBehaviour {
    ...
    void Start() {
        scopeList = Utils.CreateScope(gameObject.GetInstanceID(),"Animate(Death);Edit(this.counter,this.counter-1);PlaySound(ZomBunnyDeath);PlayParticles(DeathParticles);Compare(this.counter<0);Delete(this)");
