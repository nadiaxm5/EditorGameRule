...
public static class ActorScheduler
{
    ...
    // Kept as a no-op so scenes generated by an older editor revision keep
    // compiling long enough to be regenerated with the fixed-only scheduler.
    [System.Obsolete("GameRule actors are evaluated only from RunFixedUpdate.")]
